  ...
  useEffect(() => {
    if (isEditMode) {
      ...
      const fetchNextNumber = async () => {
        try {
          const response = await api.get("/suppliers/next-number");
          setFormData((prev) => ({
            ...prev,
            supplierNumber: response.data.nextNumber,
          }));
        } catch (err) {
          console.error("Error fetching next supplier number:", err);
        }
      };
      fetchNextNumber();
    }
              ...
              <input
                ...
                value={
                  formData.supplierNumber
                    ? formData.supplierNumber.toString().padStart(5, "0")
                    : t("autoGenerated")
                }
                disabled
                style={{
